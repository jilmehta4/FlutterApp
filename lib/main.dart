...
import 'package:project2flutter/lenskart.dart';
import 'package:project2flutter/detail_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Lenskart'),
    );
  }
}
                ...
                child: Card(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(lenskartList[index].name, style: TextStyle(fontSize: 25, fontWeight: FontWeight. bold)),
                        Text(lenskartList[index].price.toString(), style: TextStyle(fontSize: 20))
                      ],)
                )
            );
          }
