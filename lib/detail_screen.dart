...
import 'package:project2flutter/cart_screen.dart';
    ...
    return Scaffold(
        ...
        body: Padding(
          ...
          Column(
            ...
            Text(lenskart.name, style: TextStyle(fontSize: 35, fontWeight: FontWeight. bold)),
            Text(lenskart.description, style: TextStyle(fontSize: 15)),
